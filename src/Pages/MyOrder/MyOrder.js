    ...
    return (
        <div>
            <div className="m-auto mb-5 p-5 bg-dark text-light">
                <div className="container p-lg-5 p-md-5 p-0 py-5 bg-dark top-section ">
                    <Row className="px-5 w-100 d-flex justify-content-center">
                        <Col xs={12} md={6} lg={2} className="p-0 p-md-0 p-lg-0 p-sm-2 justify-content-end">
                            <div className="">
                               <img className="user-photo" src={user?.photoURL} alt="" />
                            </div>
                        </Col>
                        <Col xs={12} md={6} lg={6} className="justify-content-start p-0 p-md-0 p-lg-0 p-sm-2">
                            <div className="text-start">
                                <h3 className="text-start pt-3 fs-4">{user?.displayName}</h3>
